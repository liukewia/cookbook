...
1 teaspoon dried minced garlic (Optional).""",
         'directions': """Place the soy sauce, olive oil, lemon juice, Worcestershire sauce, garlic powder, basil, parsley, and pepper in a blender. Add hot pepper sauce and garlic, if desired. 
...
1.25 cups chopped pecans""",
         'directions': """Preheat oven to 350 degrees F (175 degrees C). Butter and flour two 9 x 5-inch loaf pans.
...
1/4 cup chopped cilantro (Optional)""",
         'directions': """Combine water, sugar, and yeast in a bowl. Let stand until yeast softens and forms a creamy foam, about 15 minutes.
...
1 cup mild shredded Cheddar cheese""",
         'directions': """Preheat oven to 400 degrees F (200 degrees C). Grease 18 muffin cups with cooking spray.
...
cooking spray""",
         'directions': """Preheat a waffle iron according to manufacturer's instructions.
...
2 tablespoons cornstarch""",
         'directions': """Combine rhubarb, strawberries, 1/2 cup sugar, lemon juice and 1 tablespoon of water in a saucepan. Cook, covered, over medium-low heat, stirring occasionally until mixture begins to boil, about 5 minutes. Reduce heat to low.
...
1 (8 ounce) package shredded mild Cheddar cheese""",
         'directions': """Preheat oven to 375 degrees F (190 degrees C). Line a 9x13-inch baking dish with parchment paper.
...
1/2 cup butter
salt to taste""",
         'directions': """Season chuck roast with salt and black pepper; sear in a large, deep skillet or Dutch oven over medium heat until browned, about 10 minutes per side.
...
2 teaspoons chopped fresh flat-leaf parsley""",
         'directions': """Season beef with a pinch of salt and black pepper. Heat vegetable oil in a heavy pot over high heat. Cook and stir beef in hot oil until browned, 5 to 8 minutes.
...
1 (2 pound) salmon fillet, cut into 3-inch pieces""",
         'directions': """Stir salt, paprika, cardamom, coriander, and black pepper together in a bowl. Add oil and maple syrup and stir until evenly combined.
...
Drizzle sauce over pork, apples, and sweet potatoes. Slice tenderloins and serve.""",
        ...
        {'title': 'Als Burmese Chicken Curry',
         'ingredients': """1 teaspoon butter, or as needed
